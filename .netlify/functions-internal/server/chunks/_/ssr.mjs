...
import { createRootRouteWithContext, Outlet, HeadContent, Scripts, createFileRoute, lazyRouteComponent, RouterProvider, Link, useRouter, useMatch, rootRouteId as rootRouteId$1, ErrorComponent, createRouter as createRouter$1 } from '@tanstack/react-router';
...
async function loadVirtualModule(id) {
  switch (id) {
    ...
    case VIRTUAL_MODULES.startManifest:
      return await import('./_tanstack-start-manifest_v-CbYKcVi7.mjs');
...
const appCss = "/assets/app-CRWwsKAG.css";
const seo = ({
  title,
  description,
  keywords,
...
function RootDocument({ children }) {
  return /* @__PURE__ */ jsxs("html", { lang: "en", children: [
    ...
    /* @__PURE__ */ jsxs("body", { className: "font-serif", children: [
      /* @__PURE__ */ jsx(ScrollArea, { className: "h-screen", children }),
...
const $$splitComponentImporter = () => import('./index-DjPDumrp.mjs');
...
function createRouter() {
  ...
  const CONVEX_URL = "https://original-dove-292.convex.cloud";
